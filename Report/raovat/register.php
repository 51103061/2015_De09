            ...
            if($fn && $ln && $e && $p) {
                ...
                if(mysqli_num_rows($r) == 0) {
                    ...
                    if(mysqli_affected_rows($dbc) == 1) {
                        ...
                        $body = "Thank you for register, please click this link to activate your account \n\n ";
                        $body .= BASE_URL . "processor/activate.php?x=".urlencode($e)."&y={$a}";
                        if(mail($e, 'Activate Account', $body, 'FROM: localhost')) {
                            $message = "<p class='success'>Register successfull. Please activate your account to log in</p>";
                        } else {
                            $message = "<p class='warning'>Could not sent email. Sorry for this uncomfortable</p>";
                        }
                    } else {
